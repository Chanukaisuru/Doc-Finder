    ...
    <div class="main">
        ...
        <div class="col-div-4">
            <div class="content-box" style="padding-left: 40px;">
                ...
                <iframe src="https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=<?php echo urlencode($doctor['location']); ?>" width="250" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>   
